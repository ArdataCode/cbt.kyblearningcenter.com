...
Route::middleware([IsAdmin::class])->group(function () {
    ...
    // Kategori Soal
    Route::get('kategorisoalessay', [App\Http\Controllers\KategoriSoalEssayController::class, 'index']);
    Route::post('storekategorisoalessay', [App\Http\Controllers\KategoriSoalEssayController::class, 'store']);
    Route::post('/updatekategorisoalessay/{id}', [App\Http\Controllers\KategoriSoalEssayController::class, 'update']);
    Route::post('/hapuskategorisoalessay/{id}', [App\Http\Controllers\KategoriSoalEssayController::class, 'destroy']);
    ...
    // Master Soal Essay
    Route::get('mastersoalessay/{idkategori}', [App\Http\Controllers\MasterSoalEssayController::class, 'index']);
    Route::post('storemastersoalessay', [App\Http\Controllers\MasterSoalEssayController::class, 'store']);
    Route::get('editmastersoalessay/{idkategori}/{id}', [App\Http\Controllers\MasterSoalEssayController::class, 'edit']);
    Route::post('/updatemastersoalessay/{id}', [App\Http\Controllers\MasterSoalEssayController::class, 'update']);
    Route::post('/hapusmastersoalessay/{id}', [App\Http\Controllers\MasterSoalEssayController::class, 'destroy']);
    Route::post('/hapusmastersoalessayall', [App\Http\Controllers\MasterSoalEssayController::class, 'destroyall']);
    Route::post('importsoalessay', [App\Http\Controllers\MasterSoalEssayController::class, 'importsoal']);
    ...
    Route::post('/updatestatusranking', [App\Http\Controllers\PaketSoalMstController::class, 'updatestatusranking']);
    Route::post('/updatenilaiessay/{id}', [App\Http\Controllers\PaketSoalMstController::class, 'updatenilaiessay']);
    ...
    Route::get('paketsoalessayktg/{id}', [App\Http\Controllers\PaketSoalEssayController::class, 'indexktg']);
    Route::post('storepaketsoalessayktg', [App\Http\Controllers\PaketSoalEssayController::class, 'storektg']);
    Route::post('/updatepaketsoalessayktg/{id}', [App\Http\Controllers\PaketSoalEssayController::class, 'updatektg']);
    Route::post('/hapuspaketsoalessayktg/{id}', [App\Http\Controllers\PaketSoalEssayController::class, 'destroyktg']);

    Route::get('paketsoalessaydtl/{id}', [App\Http\Controllers\PaketSoalEssayController::class, 'indexdtl']);
    Route::post('storepaketsoalessaydtl/{idmst}/{idktg}', [App\Http\Controllers\PaketSoalEssayController::class, 'storedtl']);
    ...
    Route::post('/hapustransaksi/{id}', [App\Http\Controllers\UserListController::class, 'hapustransaksi']);
...
Route::middleware([PreventBackHistory::class])->group(function () {
    ...
    Route::post('updatejawabanessay', [App\Http\Controllers\UserController::class, 'updatejawabanessay']);
    Route::post('updatejawabanessayfile', [App\Http\Controllers\UserController::class, 'updatejawabanessayfile']);
