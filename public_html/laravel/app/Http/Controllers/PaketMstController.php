...
class PaketMstController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $datadtl['batas_mengerjakan'] = $request->batas_mengerjakan[0];
        ...
        $updatedata = PaketDtl::where('fk_paket_mst',$id)->update($datadtl);
    ...
    public function storedtl(Request $request)
    {
        ...
        $paketmst = PaketMst::find($request->fk_mapel_mst_add);
        $data['fk_mapel_mst'] = $request->fk_mapel_mst_add;
        $data['fk_paket_mst'] = $request->fk_paket_mst;
        $data['batas_mengerjakan'] = $paketmst->batas_mengerjakan;
        $data['jenis'] = 1;
        $data['created_by'] = Auth::id();
        $data['created_at'] = Carbon::now()->toDateTimeString();
        $data['updated_by'] = Auth::id();
