    ...
    */
    ...
    public function exportsoal($jns , $id){
        ...
        if ($jns=="pilgan") {
            ...
            $paketsoalessayktg = PaketSoalEssayKtg::where('fk_paket_soal_mst',$id)->inRandomOrder()->get();
            $paketsoalessaydtl = PaketSoalEssayDtl::where('fk_paket_soal_mst',$id)->get();

            $data = [
                'paketsoalktg'=> $paketsoalktg,
                'paketsoalmst'=>$paketsoalmst,
                'paketsoaldtl'=>$paketsoaldtl,
                'paketsoalessayktg'=>$paketsoalessayktg,
                'paketsoalessaydtl'=>$paketsoalessaydtl,
            ];

            // $data_param = [
            //     'paketsoalktg','paketsoalmst','paketsoaldtl','paketsoalessayktg','paketsoalessaydtl'
            // ];
            // return view('pdf/SoalPilGan')->with(compact($data_param));
