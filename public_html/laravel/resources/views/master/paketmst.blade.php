                    ...
                    <td width="1%" class="_align_center">
                      <div class="btn-group">
                        ...
                        <span data-toggle="tooltip" data-placement="left" title="Paket">
                          <a href="{{url('paketdtl')}}/{{$key->id}}" class="btn btn-sm btn-outline-primary"><i class="fas fa-th-list"></i></a>
                        </span>
                      </div>
                    </td>
                    <td width="1%" class="_align_center">
          ...
          <form method="post" id="formData_{{$key->id}}" class="form-horizontal">
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group">
                    <label for="batas_mengerjakan_{{$key->id}}">Batas Mengerjakan<span class="bintang">*</span> <i>(Isi 0 Untuk Selamanya)</i></label>
