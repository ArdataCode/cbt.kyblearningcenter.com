...
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a class="_kembali" href="{{url('kategorisoalessay')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a></li>
</ol>
@endsection
                    ...
                    <td width="1%" class="middle">
                      <div class="btn-group">
                        <span data-toggle="tooltip" data-placement="left" title="Ubah Data">
                          ...
                          <a type="button" class="btn btn-sm btn-outline-warning" href="{{url('editmastersoalessay')}}/{{$idkategori}}/{{$key->id}}"><i class="fas fa-edit"></i></a>
                        </span>
                        @php
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              <!-- <div class="card-body"> -->
                <input type="hidden" name="fk_kategori_soal_essay_add" value="{{$idkategori}}">
      ...
      <div class="modal-content">
        ...
        <form method="post" id="_formDataImport" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="modal-body">
              <!-- <div class="card-body"> -->
              <div class="form-group">
                <label>Download Template Excel <a href="{{asset('document/TemplateSoalEssay.xlsx')}}">disini</a></label>
              </div>
  ...
  $(document).ready(function(){
    ...
    //Fungsi Hapus Data All
      $(document).on('click', '.btn-hapus-all', function (e) {
        ...
        var url = "{{ url('/hapusmastersoalessayall') }}";
        $.ajaxSetup({
            headers: {
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "{{ url('/hapusmastersoalessay') }}/"+idform;
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
    ...
    $('#_formData').validate({
          ...
          submitHandler: function () {
            ...
            var url = "{{ url('storemastersoalessay') }}";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
