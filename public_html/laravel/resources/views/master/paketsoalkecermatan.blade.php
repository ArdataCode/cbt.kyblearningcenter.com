          ...
          <form method="post" id="formData_{{$key->id}}" class="form-horizontal">
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group">
                    <label for="kkm_{{$key->id}}">KKM Total (1-100)<span class="bintang">*</span></label>
                    <input type="text" class="form-control int" id="kkm_{{$key->id}}" name="kkm[]" placeholder="KKM Total (1-100)" value="{{$key->kkm}}">
                </div>
                <div class="form-group">
      ...
      <div class="modal-content">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                <label for="kkm_add">KKM Total (1-100)<span class="bintang">*</span></label>
                <input type="text" class="form-control int" id="kkm_add" name="kkm_add" placeholder="KKM Total (1-100)" value="0">
              </div>
              <div class="form-group">
