                    ...
                    <td width="1%" class="_align_center">
                      <div class="btn-group">
                        <span data-toggle="tooltip" data-placement="left" title="Soal">
                          <a href="{{url('paketsoalessaydtl')}}/{{$key->id}}" class="btn btn-sm btn-outline-info"><i class="fas fa-th-list"></i></a>
                        </span>
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group" style="display:none">
                    ...
                    <input type="hidden" class="form-control int" id="kkm_{{$key->id}}" name="kkm[]" placeholder="KKM Perkategori" value="{{$key->kkm}}" {{$datamst->jenis_penilaian==1 ? "max=100" : ""}}>
                </div>              
                <!-- /.form-group -->
              <!-- </div> -->
            </div>
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              ...
              <div class="form-group" style="display:none">
                  ...
                  <input type="hidden" class="form-control int" id="kkm_add" name="kkm_add" placeholder="KKM Perkategori" value="50" {{$datamst->jenis_penilaian==1 ? "max=100" : ""}}>
              </div> 
              <!-- <div class="card-body"> -->
              <!-- /.form-group -->
            <!-- </div> -->
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "{{ url('/hapuspaketsoalessayktg') }}/"+idform;
        $.ajaxSetup({
            headers: {
    ...
    $(document).on('click', '.btn-submit-data', function (e) {
        ...
        $('#formData_'+idform).validate({
          ...
          submitHandler: function () {
            ...
            var url = "{{ url('/updatepaketsoalessayktg') }}/"+idform;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
    ...
    $('#_formData').validate({
          ...
          submitHandler: function () {
            ...
            var url = "{{ url('storepaketsoalessayktg') }}";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
