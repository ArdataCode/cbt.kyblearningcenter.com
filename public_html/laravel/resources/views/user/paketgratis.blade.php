                          ...
                          <div class="modal-content">
                              ...
                              <div class="table-responsive mt-3">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td>Jumlah Soal</td>
                                    <td>
                                      <h6>{{$key->total_soal}} Soal</h6>
                                      @if(count($key->paket_soal_dtl_r)>0) 
                                      <h6>[ {{count($key->paket_soal_dtl_r)}} Pilihan Ganda ]</h6>
                                      @endif
                                      @if(count($key->paket_soal_essay_dtl_r)>0) 
                                      <h6>[ {{count($key->paket_soal_essay_dtl_r)}} Essay ]</h6>
                                      @endif
                                    </td>
                                  </tr>
                                  <tr>
                            ...
                            <div class="modal-footer" style="justify-content:center">
                              <form method="post" id="formKerjakan_{{$key->id}}" class="form-horizontal">
                                @csrf
                                <input type="hidden" name="id_paket_dtl[]" value="{{Crypt::encrypt(0)}}">
